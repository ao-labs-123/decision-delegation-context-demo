...
CONTEXT_TYPES = {
    ...
    "responsibility_shift": {
        ...
        "description": (
            "自らの行動意思は示しつつも、"
            "実行可否を相手の都合や許可に依存させる文脈タイプ。"
        ),
        "deep_dive": "お時間あればご質問したいのですが。",
        "examples": [
            "お時間あればご質問したいのですが。",  # 深掘り
            "よろしければご一緒します。",
            "可能でしたら確認いただけますか。",
            "差し支えなければ教えてください。",
            "ご都合がよければ進めます。"
        ...
        "interpretation": {
            "stage1": "行動意図を含む発話である。",
            "stage2": "実行は条件付きで提示されている。",
            "stage3": "条件は相手の都合・許可に依存している。",
            "stage4": "判断主体は形式上相手側に置かれている。",
            "stage5": "話者の行動は相手の可否判断によって確定する構造を持つ。"
        },
        "note": (
            "直接的な責任移動ではなく、"
            "相手の可否確認を通じて行動を条件化する文脈構造。"
        )
    }
}
